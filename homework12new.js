...
function myTheory() {
    ...
    var odd = 0;
    var amount = 0;
    var count = 55; // How many random numbers to generate
    ...
    var percentageEven = (even / count) * 100;
    var percentageOdd = (odd / count) * 100;
    
    console.log(`Amount of numbers: ` + amount);
    console.log(`Even Numbers: ` + even + ` and Odd Numbers: ` + odd);
    console.log(`Percentage of even numbers: ` + Math.round(percentageEven) + ` %` + `: ` + Math.round(percentageOdd) + ` %;`);
}
